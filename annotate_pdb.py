...
# Import both original and optimized transforms
from collapse.data import EmbedTransform as OriginalEmbedTransform
from gen_embed import OptEmbedTransform as OptimizedEmbedTransform
...
if args.mode == 'original':
    ...
    transform = OptimizedEmbedTransform(model, include_hets=args.include_hets, device=device)
